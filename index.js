...
class Car {
  ...
  drive(dist){
    const drivablesMiles = this.tank * this.milesPerGallon;
    if (dist <= drivablesMiles){
      this.odometer = this.odometer + dist;
      this.tank = this.tank - (dist/ this.milesPerGallon);
    }else {
      this.odometer =this.odometer + drivablesMiles;
      this.tank = 0;
      return `I ran oout of fuel at ${this.odometer}miles!`
    }
  }
}
